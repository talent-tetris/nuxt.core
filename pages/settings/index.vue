...
<template>
  ...
  <div class="max-w-3xl mx-auto space-y-2 p-2">
    <div class="bg-white dark:bg-gray-900 rounded-md">
      <div class="p-2">
        <u-button icon="i-ph-user-bold" size="xl" color="gray" variant="ghost" label="Аккаунт" block class="justify-start"/>
        <hr class="border-gray-200 dark:border-gray-800 my-2 mx-2">
        <u-button to="/settings/appearance" icon="i-ph-palette-bold" size="xl" color="gray" variant="ghost" label="Внешний вид" block
                  class="justify-start"/>
